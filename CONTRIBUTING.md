...
Thank you for your interest in contributing to the Playful Sparkle IndexNow extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_indexnow/issues) to avoid duplicates.
...
1. Update the appropriate language files in `/admin/language/` or `/catalog/language/`.
...
- Validate edge cases, such as different IndexNow configurations or large catalogs.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_indexnow/issues)
