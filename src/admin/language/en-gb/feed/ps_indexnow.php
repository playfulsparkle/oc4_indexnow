...
$_['text_getting_started']         = '<p><strong>Overview:</strong> xxxxxxxx</p><p><strong>Requirements:</strong> OpenCart 4.x+, PHP 7.4+ or higher.</p>';
$_['text_setup']                   = '<p><strong>xxxxxx</strong> xxxxxx.</p>';
$_['text_troubleshot']             = '<ul><li><strong>xxxx</strong> xxxxxxx</li></ul>';
$_['text_faq']                     = '<details><summary>xxxxx</summary>xxxxxxx</details>';
