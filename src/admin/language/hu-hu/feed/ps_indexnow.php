...
<details><summary><strong>A várólista nincs feltöltve</strong></summary> Győződjön meg róla, hogy a keresőmotorok értesítése opciók engedélyezve vannak. Ezek az opciók lehetővé teszik a rendszer számára, hogy URL-eket sorakoztasson fel kategóriák, termékek, gyártók vagy cikkek számára, amikor azok hozzáadódnak, frissülnek vagy törlődnek.</details>
<details><summary><strong>Nem engedélyezett szolgáltatás. Kérjük, engedélyezzen legalább egy szolgáltatást</strong></summary> Legalább egy IndexNow szolgáltatást engedélyeznie kell, mielőtt rákattintana a "Várólistás URL-ek benyújtása" gombra.</details>';
$_['text_faq'] = '<details><summary><strong>Hogyan engedélyezhetem vagy tilthatom le a bővítményt minden egyes bolt számára?</strong></summary><p>A bővítményt minden egyes bolt számára külön-külön engedélyezheti vagy tilthatja le a bővítmény beállításainál.</p></details>
<details><summary><strong>Engedélyezhetem vagy tilthatom le az IndexNow szolgáltatásokat minden egyes bolt számára?</strong></summary><p>Igen, az IndexNow szolgáltatásokat minden egyes bolt számára külön-külön engedélyezheti vagy tilthatja le a bővítmény beállításainál.</p></details>
<details><summary><strong>Hogyan generálhatok szolgáltatáskulcsot minden egyes bolt számára?</strong></summary><p>A szolgáltatáskulcs a telepítéskor automatikusan generálódik, és minden egyes bolt számára egyedi. Nem szükséges manuálisan generálni.</p></details>
<details><summary><strong>Újra generálhatom a szolgáltatáskulcsot minden egyes bolt számára?</strong></summary><p>Igen, a szolgáltatáskulcsot minden egyes bolt számára újra generálhatja a bővítmény beállításainál. Ez lehetőséget ad a kulcs frissítésére vagy módosítására szükség szerint.</p></details>
<details><summary><strong>Használhatok egyéni Cron URL-t az URL-ek IndexNow szolgáltatásokhoz történő küldésére?</strong></summary><p>Igen, választhatja a bővítmény által biztosított Cron URL-t, vagy az OpenCart Cron oldal URL-jét az URL-ek küldésére. Mindkét lehetőség problémamentesen működik.</p></details>
<details><summary><strong>Mekkora a méret- és URL-határ a webhely térképen?</strong></summary><p>A webhelytérkép fájl mérete legfeljebb 50 MB lehet, és legfeljebb 50 000 URL-t tartalmazhat. Győződjön meg arról, hogy a webhelytérkép nem lépi túl ezeket a határokat.</p></details>
<details><summary><strong>Hogyan küldhetek URL-eket az IndexNow szolgáltatásoknak?</strong></summary><p>URL-eket küldhet az IndexNow szolgáltatásoknak a webhelytérkép importálásával, XML webhelytérkép fájl feltöltésével, vagy manuálisan a webhelytérkép URL-jének megadásával. Ezen kívül egyes URL-eket is benyújthat a várólistából, vagy egyszerre küldheti el az összes várólistás URL-t a kiválasztott bolt számára.</p></details>
<details><summary><strong>Hogyan törölhetem az URL-benyújtási naplót?</strong></summary><p>A naplót a Napló fül alatt törölheti. A napló törlése mindig hiba nélkül megtörténik, amikor ezt választja.</p></details>';
